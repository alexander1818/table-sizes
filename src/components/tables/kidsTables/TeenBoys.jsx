...
const rows = [
    createData('11-12y', '28.7-30.3', '24.8-25.6', '31-32.7'),
    createData('12-13y', '30-31.5', '25.2-26.4', '32.3-34.3'),
    createData('13-14y', '31-32.7', '26-26.8', '33.9-35.4'),
    createData('14-15y', '32.3-34', '26.4-27.6', '35-37'),
    createData('15-16y', '33.5-35', '27.2-28', '36.6-38.2'),
    createData('From 16y', '34.6-36.2', '27.6-28.7', '37.8-39.8'),
    createData('From 17y', '35.8-37.4', '28.3-29.5', '39.4-41.3'),
];
